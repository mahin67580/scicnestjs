  ...
  return (
    <>
      ...
      <main className="px-5 md:px-20 py-10 text-center">
        ...
        {/* Modal */}
        {selectedProduct && (
          <div className="fixed w-11/12 mx-auto inset-0 flex items-center justify-center z-50 backdrop-blur-2xl  bg-opacity-50">
            <div className="bg-white rounded-lg p-8 max-w-md w-full relative">
              ...
              <p className="font-bold text-black text-lg mb-4">Price ${selectedProduct.price}</p>
              <button
